...
public class ManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LoadData();
		Debug.Log(hills.Count);
        if (hills.Count == 0)
        {
            hills.Add(GetProfileData(new Hill(Hill.ProfileType.ICR1992, 42, 120, 0.575f, 35, 11, 95.2f, 20.5f, 6.5f, 107, 37.5f, 37.5f, 37.5f, 3, 30, 11, 0, 0, 126f), "Hakuba HS131"));
            hills.Add(GetProfileData(new Hill(Hill.ProfileType.ICR1996, 35, 120, 0.575f, 35, 11, 99, 23, 6.5f, 115, 37.43f, 35.5f, 32.4f, 3.38f, 11.15f, 17.42f, 321, 100, 100), "Oberstdorf HS137"));
            hills.Add(GetProfileData(new Hill(Hill.ProfileType.ICR2008, 35, 125, 0.575f, 35, 11, 98.7f, 22, 6.5f, 90, 37.05f, 34.3f, 31.4f, 3.13f, 16, 15, 310, 168, 99.3f), "Zakopane HS140"));
		}
