...
using EventType = Competition.EventType;
...
namespace UI
{
    public class EventsListUI : ListDisplay
    {
        ...
        public void LoadList(List<EventInfo> tmpList)
        {
            ...
            if (tmpList == null) { tmpList = new List<EventInfo>(); }
            ListInit();
        ...
        public void Add()
        {
            EventInfo e = new EventInfo("", EventType.Individual, new List<RoundInfo>(), new List<int>(), RankType.None, 0, RankType.None, 0);
            eventsList.Add(e);
