...
namespace OpenSkiJumping.UI
{
    ...
    //     private ResultsDatabase resultsContainer;
    ...
    //     public TMP_Text resultsInfoText;
    ...
    //         var dropdownList = calendar.classifications.Select(x => new TMP_Dropdown.OptionData(x.name));
    //         resultsDropdown.options = new List<TMP_Dropdown.OptionData>(dropdownList);
    ...
    //     }
    //
    //     public void ShowEventResults(ResultsDatabase calendarResults, int classificationId)
    //     {
